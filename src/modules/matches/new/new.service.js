import { findProfileByUserId, findNewCandidates } from './new.repository.js';
import { getShortlistedUserIds } from '../shortlisted.repository.js';

import { calculateMatchScore } from '../score.service.js';
import { MINIMUM_MATCH_SCORE, NEW_MATCH_DAYS } from '../matches.constants.js';
...
export const getNewMatchesService = async ({ userId, filters, sortBy, search, page, limit }) => {
  ...
  const createdAfter = new Date(Date.now() - NEW_MATCH_DAYS * 24 * 60 * 60 * 1000);
